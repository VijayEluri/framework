...
public class HttpPostRequestEncoder implements ChunkedInput {
    ...
    */
            ...
            if (duringMixedMode) {
                ...
                if (currentFileUpload != null &&
                    ...
                    replacement += HttpHeaders.Names.CONTENT_TYPE+": "+
                        HttpPostBodyUtil.MULTIPART_MIXED+"; "+BOUNDARY+
                        "="+multipartMixedBoundary+"\r\n\r\n";
    ...
    public HttpRequest finalizeRequest() throws ErrorDataEncoderException {
        ...
        if (contentTypes != null) {
            ...
            for (String contentType: contentTypes) {
                ...
                if (contentType.toLowerCase().startsWith(MULTIPART_FORM_DATA)) {
                    // ignore
                } else if (contentType.toLowerCase().startsWith(APPLICATION_X_WWW_FORM_URLENCODED)){
                    // ignore
                } else {
        ...
        if (isMultipart) {
            String value = MULTIPART_FORM_DATA + "; " + BOUNDARY + "=" + multipartDataBoundary;
            request.addHeader(HttpHeaders.Names.CONTENT_TYPE, value);
        } else {
            // Not multipart
            request.addHeader(HttpHeaders.Names.CONTENT_TYPE, APPLICATION_X_WWW_FORM_URLENCODED);
        }
