...
import org.oobium.app.server.netty4.HttpPostBodyUtil.TransferEncodingMechanism;
...
public class HttpPostRequestDecoder {
    ...
    */
    ...
    private void checkMultipart(String contentType)
        ...
        if (headerContentType[0].toLowerCase().startsWith(MULTIPART_FORM_DATA) &&
                headerContentType[1].toLowerCase().startsWith(BOUNDARY)) {
