 ...
 * under the License.
 */
package org.oobium.app.server.netty4;
...
public class DefaultHttpDataFactory implements HttpDataFactory {
     ...
     */
    private ConcurrentHashMap<HttpRequest, List<HttpData>> requestFileDeleteMap = new ConcurrentHashMap<HttpRequest, List<HttpData>>();
    ...
    @Override
    public Attribute createAttribute(HttpRequest request, String name) throws NullPointerException, IllegalArgumentException {
        if (useDisk) {
     ...
     */
    @Override
    public Attribute createAttribute(HttpRequest request, String name, String value) throws NullPointerException, IllegalArgumentException {
        if (useDisk) {
            Attribute attribute;
            try {
     ...
     */
    @Override
    public FileUpload createFileUpload(HttpRequest request, String name, String filename, String contentType, String contentTransferEncoding, Charset charset, long size) throws NullPointerException, IllegalArgumentException {
        if (useDisk) {
