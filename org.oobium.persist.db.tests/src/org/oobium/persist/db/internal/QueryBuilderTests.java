...
public class QueryBuilderTests {
	...
	public void testIncludes0() throws Exception {
		List<Object> includes = QueryBuilder.processModelIncludes(Start0.class, null);
	...
	public void testIncludes01() throws Exception {
		String sql = "include:*";
		List<Object> includes = QueryBuilder.processModelIncludes(Start0.class, sql);
	...
	public void testIncludes1() throws Exception {
		List<Object> includes = QueryBuilder.processModelIncludes(Start1.class, null);
	...
	public void testIncludes11() throws Exception {
		...
		List<Object> includes = QueryBuilder.processModelIncludes(Start1.class, sql);
	...
	public void testHasOneSql1() throws Exception {
		Query query = QueryBuilder.build(Start1.class, null);
	...
	public void testHasOneSql2() throws Exception {
		...
		Query query = QueryBuilder.build(Start1.class, sql);
	...
	public void testHasOneSql5() throws Exception {
		...
		QueryBuilder.build(Start1.class, sql);
	}
	...
	public void testIncludes2() throws Exception {
		String sql = "include:{a:[b,c]}";
		List<Object> includes = QueryBuilder.processModelIncludes(Start2.class, sql);
	...
	public void testIncludes3() throws Exception {
		String sql = "include:{a:[b,c]}";
		List<Object> includes = QueryBuilder.processModelIncludes(Start3.class, sql);
	...
	public void testIncludes4() throws Exception {
		...
		List<Object> includes = QueryBuilder.processModelIncludes(Start4.class, sql);
	...
	public void testIncludes5() throws Exception {
		List<Object> includes = QueryBuilder.processModelIncludes(Start5.class, null);
	...
	public void testIncludes51() throws Exception {
		...
		List<Object> includes = QueryBuilder.processModelIncludes(Start5.class, sql);
	...
	public void testHasManyToNoneSql() throws Exception {
		String sql = "include:a";
		Query query = QueryBuilder.build(Start6.class, sql);
		...
		String expected = "SELECT a.a6s__null a_id,b.id b_id FROM a6s__null___start6s__a a INNER JOIN a6s b ON a.start6s__a=b.id AND a.a6s__null IN (#{ids})";
	...
	public void testHasManyToNoneThroughSql() throws Exception {
		...
		Query query = QueryBuilder.build(Start7.class, sql);
	...
	public void testHasManyToManySql() throws Exception {
		String sql = "include:a";
		Query query = QueryBuilder.build(Start8.class, sql);
		...
		String expected = "SELECT a.a8s__start a_id,b.id b_id FROM a8s__start___start8s__a a INNER JOIN a8s b ON a.start8s__a=b.id AND a.a8s__start IN (#{ids})";
		assertEquals(expected, child.getSql());
	}
	...
	public void testHasManyToManyThroughSql() throws Exception {
		String sql = "include:b";
		Query query = QueryBuilder.build(Start9.class, sql);
	...
	public void testHasManyToOneSql() throws Exception {
		String sql = "include:a";
		Query query = QueryBuilder.build(Start10.class, sql);
	...
	public void testHasManyToOneThroughSql() throws Exception {
		String sql = "include:b";
		Query query = QueryBuilder.build(Start11.class, sql);
	...
	public void testHasOneToManySql() throws Exception {
		String sql = "include:a";
		Query query = QueryBuilder.build(Start12.class, sql);
