...
public class Constants {
	...
	static {
		...
		HTML_TAGS.put("capture", "Render the children of this element into the given variable (ESP)\nUsage: capture(var1) - will capture the rendered HTML into a new String variable named var1");
		HTML_TAGS.put("contentFor", "Render the children of this element into the yield element of the same name (ESP)\n" +
