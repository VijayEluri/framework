...
public class ServiceSelectionDialog extends SelectionStatusDialog {
...
//	private final static String DIALOG_SETTINGS_SHOW_ALL = "ProjectSelectionDialog.show_all"; //$NON-NLS-1$
	...
	public ServiceSelectionDialog(Shell parentShell, List<String> services) {
		super(parentShell);
		this.services = services;

		setTitle("Service Selection");
		setMessage("Select a service and press OK to accept.");
		...
		filter = new ViewerFilter() {
			public boolean select(Viewer viewer, Object parentElement, Object element) {
				return ServiceSelectionDialog.this.services.contains(element);
			}
		};
...
//		boolean doFilter = !dialogSettings.getBoolean(DIALOG_SETTINGS_SHOW_ALL) && !fProjectsWithSpecifics.isEmpty();
		...
		viewer.setInput(DataServiceManager.instance().getServices());
