...
public class NewViewWizardPage extends ProjectWizardPage {
	public static final String ID = NewViewWizardPage.class.getCanonicalName();
	...
	protected NewViewWizardPage(String pageName, IProject website) {
		...
		setMessage("Create a new web page in the current project.");
