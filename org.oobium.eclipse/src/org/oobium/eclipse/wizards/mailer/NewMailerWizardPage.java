...
public class NewMailerWizardPage extends ProjectWizardPage {
	public static final String ID = NewMailerWizardPage.class.getCanonicalName();
	...
	protected NewMailerWizardPage(String pageName, IProject website) {
		...
		setMessage("Create a new Mailer in the current project.");
