...
public class MySqlMigrateTester extends MigrateTester {
	...
	public void testAttrBoolean_Primitive() throws Exception {
		assertEquals("CREATE TABLE a_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,attr BOOLEAN NOT NULL DEFAULT false) ENGINE = INNODB CHARACTER SET UTF8",
				migrateUp(DynClasses.getModel("AModel").addAttr("attr", "boolean.class")));
	}
	
	@Test
	public void testAttrInteger() throws Exception {
		assertEquals("CREATE TABLE a_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,attr INTEGER) ENGINE = INNODB CHARACTER SET UTF8",
				migrateUp(DynClasses.getModel("AModel").addAttr("attr", "Integer.class")));
	}
	
	@Test
	public void testAttrInteger_Primitive() throws Exception {
		assertEquals("CREATE TABLE a_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,attr INTEGER NOT NULL DEFAULT 0) ENGINE = INNODB CHARACTER SET UTF8",
				migrateUp(DynClasses.getModel("AModel").addAttr("attr", "int.class")));
	}
	
	@Test
	public void testAttrString() throws Exception {
		assertEquals("CREATE TABLE a_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,attr VARCHAR(255)) ENGINE = INNODB CHARACTER SET UTF8",
	...
	public void testHasOneToNone() throws Exception {
		assertEquals(
				"CREATE TABLE a_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,b_model INTEGER) ENGINE = INNODB CHARACTER SET UTF8\n" +
				"CREATE TABLE b_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,a_model INTEGER) ENGINE = INNODB CHARACTER SET UTF8\n" +
	...
	public void testHasOneToOne() throws Exception {
		assertEquals(
				"CREATE TABLE a_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,b_model INTEGER) ENGINE = INNODB CHARACTER SET UTF8\n" +
				"CREATE TABLE b_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY) ENGINE = INNODB CHARACTER SET UTF8\n" +
	...
	public void testHasOneToOne_OppositeOrder() throws Exception {
		assertEquals(
				"CREATE TABLE b_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,c_model INTEGER) ENGINE = INNODB CHARACTER SET UTF8\n" +
				"CREATE TABLE c_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY) ENGINE = INNODB CHARACTER SET UTF8\n" +
	...
	public void testHasManyToNone() throws Exception {
		assertEquals(
				"CREATE TABLE a_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY) ENGINE = INNODB CHARACTER SET UTF8\n" +
				"CREATE TABLE b_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,a_model INTEGER) ENGINE = INNODB CHARACTER SET UTF8\n" +
				"CREATE TABLE a_models__b_models___b_models__null(a INTEGER REFERENCES b_models(id),b INTEGER REFERENCES a_models(id)) ENGINE = INNODB CHARACTER SET UTF8\n" +
	...
	public void testHasManyToMany() throws Exception {
		assertEquals(
				"CREATE TABLE a_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY) ENGINE = INNODB CHARACTER SET UTF8\n" +
				"CREATE TABLE b_models(id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY) ENGINE = INNODB CHARACTER SET UTF8\n" +
				"CREATE TABLE a_models__b_models___b_models__a_models(a INTEGER REFERENCES b_models(id),b INTEGER REFERENCES a_models(id)) ENGINE = INNODB CHARACTER SET UTF8\n" +
