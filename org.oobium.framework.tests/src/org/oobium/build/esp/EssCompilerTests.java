...
public class EssCompilerTests extends BaseEspTester {
	...
	public void testCssOnly() throws Exception {
		...
		assertEquals(".myClass{color:red}", asset(ess));

		ess = ".myClass { color: red }\n\n.myOtherClass\n\tcolor: blue";
		assertEquals(".myClass{color:red}.myOtherClass{color:blue}", asset(ess));
		...
		assertEquals("input:not([type=submit]){-moz-border-radius:8px;border-radius:8px}input[type=text]{color:grey}", asset(ess));
	}
	...
	public void testComments() throws Exception {
		assertEquals(
				"__body__.append(\".test1{color:green}.test3{color:blue}\");",
				asset("//.teasset{color: red}\n.test1{color: green}\n//.test2{color: yellow}\n.test3{color: blue}"));

		assertEquals("__body__.append(\".test1{color:green}\");", asset(".test1{color: green} // red}"));
		assertEquals("__body__.append(\".test1{color:green}\");", asset(".test1\n\tcolor: green // red}"));
	}
