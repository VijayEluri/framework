...
public class EspDomTests {
	...
	public void testConstructor() throws Exception {
		...
		assertFalse(elem(esp, ConstructorElement.class).hasSignatureArgs());
		...
		assertTrue(elem(esp).isA(ConstructorElement));
		assertTrue(elem(esp, ConstructorElement.class).hasSignatureArgs());
		assertEquals(1, elem(esp, ConstructorElement.class).getSignatureArgs().size());
		assertEquals("String", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarType());
		assertNull(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarName());
		...
		assertEquals(1, elem(esp, ConstructorElement.class).getSignatureArgs().size());
		assertEquals("String", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarType());
		assertEquals("arg1", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarName());
		...
		assertEquals(2, elem(esp, ConstructorElement.class).getSignatureArgs().size());
		assertEquals("String", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarType());
		assertEquals("arg1", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarName());
		assertFalse(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).isVarArgs());
		assertEquals("byte[]", elem(esp, ConstructorElement.class).getSignatureArgs().get(1).getVarType());
		assertEquals("arg2", elem(esp, ConstructorElement.class).getSignatureArgs().get(1).getVarName());
		assertFalse(elem(esp, ConstructorElement.class).getSignatureArgs().get(1).isVarArgs());

		esp = "MyEsp(int ... arg)";
		assertEquals("MyEsp(int ... arg)", elem(esp).getText());
		assertNotNull(elem(esp, ConstructorElement.class).getSignatureArgs());
		assertEquals(1, elem(esp, ConstructorElement.class).getSignatureArgs().size());
		assertEquals("int", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarType());
		assertEquals("arg", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarName());
		assertTrue(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).isVarArgs());
		...
		assertNotNull(elem(esp, ConstructorElement.class).getSignatureArgs());
		assertEquals(1, elem(esp, ConstructorElement.class).getSignatureArgs().size());
		assertNull(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarType());
		assertEquals("arg", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarName());
		assertTrue(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).isVarArgs());
		...
		assertNotNull(elem(esp, ConstructorElement.class).getSignatureArgs());
		assertEquals(3, elem(esp, ConstructorElement.class).getSignatureArgs().size());
		assertEquals("String", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarType());
		assertEquals("arg1", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarName());
		assertFalse(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).isVarArgs());
		assertEquals("byte[]", elem(esp, ConstructorElement.class).getSignatureArgs().get(1).getVarType());
		assertEquals("arg2", elem(esp, ConstructorElement.class).getSignatureArgs().get(1).getVarName());
		assertFalse(elem(esp, ConstructorElement.class).getSignatureArgs().get(1).isVarArgs());
		assertEquals("int", elem(esp, ConstructorElement.class).getSignatureArgs().get(2).getVarType());
		assertEquals("arg3", elem(esp, ConstructorElement.class).getSignatureArgs().get(2).getVarName());
		assertTrue(elem(esp, ConstructorElement.class).getSignatureArgs().get(2).isVarArgs());
		...
		assertEquals("arg", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarName());
		assertFalse(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).isVarArgs());
		assertTrue(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).hasDefaultValue());
		assertEquals("0", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getDefaultValue());
		...
		assertEquals("arg", elem(esp, ConstructorElement.class).getSignatureArgs().get(0).getVarName());
		assertFalse(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).isVarArgs());
		assertFalse(elem(esp, ConstructorElement.class).getSignatureArgs().get(0).hasDefaultValue());
